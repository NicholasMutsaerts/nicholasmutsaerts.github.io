...
- [Restoring Windows Network Connectivity with a Winsock Reset](winsok.md)
...
- [A Step-by-Step Guide to Remote Desktop from MacOS to Windows](pdf/Remote Desktop from MacOS to Windows.pdf)
...
- [How to monitor files currently open on a Windows System](pdf/How to monitor files currently open on a Windows System.pdf)
- [Mastering the NET USE Command: A Practical Guide for IT Professionals](pdf/Net Use Command.pdf)
...
- [MacOS Cheetsheet](cheatsheet/MacOS Command Line Cheatsheet.pdf)
